...
% ── Title Block ─────────────────────────────────────────────────────────
\begin{center}
  {\LARGE\bfseries Personal Reflections:\\[3pt]
...
\input{sections/02_technical_contributions}
\input{sections/03_design_philosophy}
\input{sections/04_challenges}
\input{sections/05_skills_developed}
\input{sections/06_team_dynamics}
\input{sections/07_reflection}
