...
def main():
    ...
    parser = argparse.ArgumentParser(description="Run video with NCNN detection (full UI)")
    parser.add_argument("video", nargs="?", default="RealVideo/DJI_0001_1456x1088_cropped_30fps.mp4", help="Path to video file")
