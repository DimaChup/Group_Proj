...
def main():
    ...
    while True:
        ...
        if frame is not None:
            ...
            info = f"{timestamp:.1f}s / {duration:.1f}s | {dt:.0f}ms | Det: {det_count[0]} | {mode} | {speed:.1f}x"
            cv2.putText(disp, info, (10, disp_h - 10), cv2.FONT_HERSHEY_SIMPLEX, 0.45, (200, 200, 200), 1)
