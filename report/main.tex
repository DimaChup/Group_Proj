...
\addlinespace
\multicolumn{2}{@{}l}{\textit{Estimation evaluation}} \\
...
% Appendix AG: Evaluating GPS Estimation Against Ground Truth
\input{sections/estimation_evaluation}

% Appendix AH: Requirements verification detail (R01--R12 evidence)
\input{sections/requirements_detail}

% Appendix AI: Evaluation detail (defect register, lessons learned, second iteration)
\input{sections/evaluation_detail}

% Appendix AJ: Development methodology (simulation-first, progressive trust, timeline)
