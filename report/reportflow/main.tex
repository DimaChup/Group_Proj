...
Roll / pitch tilt & 0--6\,m & Flight only \\
\bottomrule
\end{tabular}
\end{table}

The pipeline assumes nadir viewing. During forward flight at 5\,m/s, drone pitch introduces up to 6.2\,m offset ($h\tan\theta = 35\tan 10°\approx 6.2$\,m). The centering procedure mitigates this by hovering before estimating, reducing pitch to ${<}1°$ and the error to ${<}0.6$\,m.
