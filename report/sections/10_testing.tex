...
All experiment scripts issue zero flight commands and are safe to run at any time. The CSV output format enables direct import into the analysis presented in Section~\ref{sec:results}.  Figure~\ref{fig:testing-coverage} shows the requirements coverage achieved at each testing tier.
