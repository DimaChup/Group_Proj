...
\begin{itemize}
    ...
    \item A \textbf{state-machine walkthrough}: INIT $\rightarrow$ CONNECTING $\rightarrow$ ARMING (GPS fix $\geq$ 3, satellites $\geq$ 6) $\rightarrow$ TAKEOFF (35~m) $\rightarrow$ SEARCH (18~waypoints) $\rightarrow$ CENTERING $\rightarrow$ VERIFY (35~m) $\rightarrow$ LANDING;
