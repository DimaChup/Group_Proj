...
At search altitudes of 30--35\,m, the mannequin subtends approximately 36--42 pixels in height in the $640\!\times\!640$ model input (scale factor $640/1456 = 0.4396$ from the $1456\!\times\!1088$ sensor frame).  This is above the empirical minimum for YOLOv8 detection (${\sim}20$~pixels)~\cite{yolov8}, but the target \emph{width} drops to 10--12 model pixels, leaving limited margin.  Two detection strategies were therefore evaluated:
