\subsection{Simulation Validation and Sim-to-Real Gap}\label{sec:sim-validation}
...
% ─────────────────────────────────────────────────────────────────────
\subsubsection{Three Simulation Levels and What Each Validated}\label{sec:sim-levels-val}
...
% ─────────────────────────────────────────────────────────────────────
\subsubsection{Error Injection as a Validation Tool}\label{sec:error-injection-val}
...
\begin{enumerate}
    ...
    \item \textbf{Inference throttle} (1--30\,FPS): limiting CV throughput to the Pi's measured 4\,FPS reveals that at a search speed of 5\,m/s and 30\,m altitude, the camera footprint advances ${\sim}1.25$\,m between frames---well within the ${\sim}24$\,m ground footprint width---providing approximately 19 frames of target visibility per flyover pass.
...
% ─────────────────────────────────────────────────────────────────────
\subsubsection{DJI Video Replay as a Sim-to-Real Proxy}\label{sec:dji-proxy}
...
% ─────────────────────────────────────────────────────────────────────
\subsubsection{Validation Results Summary}\label{sec:val-results}
...
% ─────────────────────────────────────────────────────────────────────
\subsubsection{Known Sim-to-Real Gaps}\label{sec:known-gaps}
...
% ─────────────────────────────────────────────────────────────────────
\subsubsection{Confidence Assessment}\label{sec:confidence}
