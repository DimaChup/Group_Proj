...
The \textsc{Verify} state implements a human-in-the-loop decision gate, motivated by the high cost of false positives in SAR operations~\cite{murphy2014}. Autonomous descent onto an incorrectly identified target wastes battery endurance, delays area coverage, and risks damage to the aircraft or bystanders. The operator classifies each detection into one of four categories:
