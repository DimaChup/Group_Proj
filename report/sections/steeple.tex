...
\begin{table}[htbp]
\centering
\caption{STEEPLE analysis summary for the autonomous SAR drone system.  Each factor identifies a key external constraint and the corresponding design decision it influenced.}
\label{tab:steeple}
\small
