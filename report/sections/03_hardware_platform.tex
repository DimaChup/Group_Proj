...
\end{equation}
%
where $W_{\mathrm{px}} = 1456$ is the image width in pixels. At the nominal search altitude of \SI{35}{\metre}, GSD~$\approx$~\SI{2.2}{\centi\metre\per px}, and a \SI{1.8}{\metre} dummy subtends roughly 82 pixels---well above the minimum detectable object size for YOLOv8n.
