...
\begin{table}[h]
\centering
\caption{Team member contributions by project area.  Each row summarises the subsystems owned by that member; overlap indicates shared integration responsibilities.}
