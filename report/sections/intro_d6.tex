...
\begin{itemize}
    ...
    \item detecting a life-size casualty surrogate (dummy) using onboard computer vision;
...
\textbf{\textcolor{red}{[NAME]} --- Flight Dynamics and State Machine Testing.}
...
\textbf{\textcolor{red}{[NAME]} --- Designated Pilot and RC Systems.}
...
\textbf{\textcolor{red}{[NAME]} --- Hardware Integration.}
...
\textbf{\textcolor{red}{[NAME]} --- Project Management and Documentation.}
