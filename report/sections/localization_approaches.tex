...
Direct georeferencing projects a pixel detection to a ground-plane GPS coordinate using the pinhole camera model, the drone's GPS position, altitude, and heading.  This is the foundational method implemented in \texttt{gps\_utils.py} and described in Section~\ref{sec:gps-math}.
