...
\begin{itemize}
  ...
  \item \textbf{NCNN inference backend.} The NCNN export of the retrained YOLOv8n model is available in \texttt{cv\_models/sar\_v2\_1088/ncnn/} and is expected to achieve ${\sim}$15\,FPS on the Pi~5 CPU, tripling the current TFLite throughput of 4.8\,FPS and enabling detection during faster transit legs.
