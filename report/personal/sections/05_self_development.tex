...
I communicate well through demonstrations and visual tools but am weaker at spontaneous verbal explanation. A second weakness is \textbf{delayed hardware testing}: I treated simulation as sufficient validation for too long. Platform-specific bugs (Python~3.13, camera colour, serial baud rates) are invisible in simulation by definition---a pattern I recognise from previous projects.
...
\begin{enumerate}
  ...
  \item \textbf{Structured communication cadence.} Adopt a ``one sentence, one diagram, one demo'' framework and schedule regular check-ins rather than relying on teammates to ask. Teaching the pilot to read mode indicators independently, and explaining the state machine to the project manager so she could write about it accurately, taught me that capability transfer is more valuable than error correction.
\end{enumerate}
